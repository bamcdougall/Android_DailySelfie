...
This GitHub Repository contains an Predictive Machine Learning project built within *Anroid Studio*.  This Repository contains **TBD** files.  The primary file is index.Rmd.  index.Rmd is the document that one would use to build the main content for this project.  This CodeBook lists out important variables used within index.Rmd.
